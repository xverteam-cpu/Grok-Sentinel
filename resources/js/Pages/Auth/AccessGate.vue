    ...
    <div class="min-h-screen bg-slate-950 px-4 py-10 text-slate-100">
        <div class="mx-auto max-w-md rounded-3xl border border-cyan-500/30 bg-slate-900/80 p-8 shadow-2xl shadow-cyan-950/40">
            ...
            <form class="space-y-5" @submit.prevent="submit">
                <div>
                    <label for="code" class="mb-2 block text-xs uppercase tracking-[0.2em] text-slate-400">Access Code</label>
                    <input
                        id="code"
                        v-model="form.code"
                        name="code"
                ...
                <div>
                    <label for="token" class="mb-2 block text-xs uppercase tracking-[0.2em] text-slate-400">Access Link Token</label>
                    <input
                        id="token"
                        v-model="form.token"
                        name="token"
