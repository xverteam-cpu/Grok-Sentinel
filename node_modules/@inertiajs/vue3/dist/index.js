  ...
  const form = (0, import_vue.reactive)({
    ...
    withPrecognition(...args2) {
      ...
      validator.on("validatingChanged", () => {
        ...
        const validationErrors = withAllErrors ?? config.get("form.withAllErrors") ? validator.errors() : (0, import_laravel_precognition.toSimpleValidationErrors)(validator.errors());
        this.errors = {};
      ...
      Object.assign(formWithPrecognition, {
        ...
        validate: (field, config3) => {
          ...
          if (field === void 0) {
            ...
            validator.validate(fieldName, (0, import_lodash_es2.get)(transformedData, fieldName), config3);
          }
          return formWithPrecognition;
        },
...
function usePage() {
  return (0, import_vue2.reactive)({
    ...
    scrollProps: (0, import_vue2.computed)(() => page.value?.scrollProps),
...
var Form = (0, import_vue5.defineComponent)({
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    if (props.withAllErrors ?? import_core5.config.get("form.withAllErrors")) {
      form.withAllErrors();
    }
    ...
    const exposed = {
      ...
      validate: (field, config3) => form.validate(...import_core5.UseFormUtils.mergeHeadersForValidation(field, config3, props.headers)),
